...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.data.success && response.data.data) {
        ...
        // Handle cases where success is false or data is missing, but no direct error was thrown by axios
  ...
  /**
   * Handles new user registration, including profile image upload.
   */
  const handleRegister = async (e) => {
    ...
    // Create a Blob for the JSON request data (RegisterRequest DTO)
    const requestData = {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setRegisterData({ name: '', email: '', phone: '', age: '', password: '', profileImageFile: null });
        setProfileImagePreviewUrl(null); // Clear image preview
      } else {
        // Handle cases where success is false, but no direct error was thrown by axios
  ...
  /**
   * Handles sending the forgot password request to the backend to generate an OTP.
   */
  const handleForgotPasswordRequest = async (e) => {
    ...
    try {
      // Send forgot password request to your Spring Boot backend
  ...
  /**
   * Handles resetting the password using the provided OTP and new password.
   */
  const handleResetPassword = async (e) => {
    ...
    try {
      // Send reset password request to your Spring Boot backend
      ...
      if (response.data.success) {
        ...
        setMode('login'); // Switch back to login form on success
        // Clear all states related to forgot password flow
  ...
  // Placeholder for Google Sign-Up logic (if you implement this in the backend later)
  const handleGoogleSignUp = () => {
    alert("Google Sign-Up integration coming soon!");
    // In a real application, you would redirect to Google's OAuth consent screen
    // or trigger a backend endpoint that handles the OAuth flow.
  };
    ...
    <form onSubmit={handleLogin} className="login-form">
      <div className="form-group">
        ...
        <input
          ...
          type="text"
          name="username"
          placeholder="Enter your email" // Changed placeholder to email as your backend uses email for username
    ...
    <div className="login-container">
      <div className="login-background">
        <div className="login-card">
          ...
          {/* The demo info is removed as we are now fully backend-driven */}
